    ...
    return (
        ...
        <div className="mx-auto bg-gray-100 rounded-lg p-8 flex flex-col">
            <form onSubmit={onSubmit}>
                    <h2 className="text-gray-900 text-lg font-medium title-font mb-5">Edit Employee</h2>
        <div className="relative mb-4">
            <label className="leading-7 text-sm text-gray-600">First Name</label>
            <input type="text" name={employee.firstName} value={firstName} 
        ...
        <button className="text-white bg-indigo-500 border-0 py-2 px-8 focus:outline-none hover:bg-indigo-600 rounded text-lg">Edit</button>
            </form>
            </div>
        </div>
    );
